...
namespace Joomla\Component\Timona\Administrator\Model;
...

{
    ...
    protected $text_prefix = 'COM_Timona_MAIN';
    ...
    public $typeAlias = 'com_timona.main';
...

    {
...

        {
            ...
            return Factory::getUser()
                ->authorise('core.delete', 'com_banners.category.' . (int)$record->catid);
...

    {
...

        {
            ...
            return Factory::getUser()
                ->authorise('core.edit.state', 'com_banners.category.' . (int)$record->catid);
...

    {
        ...
        $form = $this->loadForm('com_banners.banner', 'banner', array(
            'control' => 'jform',
            'load_data' => $loadData
        ));
...

    {
        ...
        $this
            ->_db
            ->quoteName('catid') . ' = ' . (int)$table->catid,
