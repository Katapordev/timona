...
class TimonaController extends AdminController
...

{
	...
	public function getModel($name = 'Timona', $prefix = 'Administrator', $config = array('ignore_request' => true))
...

	{
...

		{
			...
			$this->app->enqueueMessage(Text::_('COM_Timona_NO_Timona_SELECTED'), 'warning');
